...
const connectionString = 'mongodb+srv://star-trek:star-trek@cluster0.csx7u.mongodb.net/?retryWrites=true&w=majority'
...
MongoClient.connect(connectionString)
    .then(client => {
        ...
        const infoCollection = db.collection('star-trek-api')
    ...
    app.get('/api/:alienName', (req, res) => {
        const aliensName = req.params.alienName
